<template>
  <div>
    <v-navigation-drawer app clipped width="300" color="black">
...
import CreateProject from '@/components/creational/ProjectCreateDialog'
import JoinProject from '@/components/transformers/JoinProjectDialog'
